import { db } from "./db";
import { eq } from "drizzle-orm";  // Bu qatorni qo'shing
...
export interface IStorage {
  ...
  createEmpireLevel(levelData: any): Promise<EmpireLevel>;
...
export class MemStorage implements IStorage {
  ...
  async createEmpireLevel(levelData: any): Promise<EmpireLevel> {
    const empireLevel: EmpireLevel = {
      id: levelData.level,
      level: levelData.level,
      name: levelData.name,
      nameUz: levelData.nameUz,
      nameRu: levelData.nameRu,
      requiredCoins: levelData.requiredCoins,
      hourlyIncome: levelData.hourlyIncome,
      description: levelData.description || null
    };
    
    this.empireLevels.set(levelData.level, empireLevel);
    return empireLevel;
  }
