        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form className="space-y-4">
              <div>
                <label htmlFor="notification-title" className="block text-sm font-medium text-gray-700 mb-1">Sarlavha</label>
                <input
              ...
              <div>
                <label htmlFor="notification-message" className="block text-sm font-medium text-gray-700 mb-1">Xabar</label>
                <textarea
              ...
              <div>
                <label htmlFor="notification-type" className="block text-sm font-medium text-gray-700 mb-1">Habar Turi</label>
                <select id="notification-type" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div>
                <label htmlFor="notification-recipients" className="block text-sm font-medium text-gray-700 mb-1">Qabul Qiluvchilar</label>
                <select 
              ...
              <div>
                <label htmlFor="notification-schedule" className="block text-sm font-medium text-gray-700 mb-1">Yuborish Vaqti</label>
                <select id="notification-schedule" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
