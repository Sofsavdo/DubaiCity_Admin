...
const TopInfoPanel = ({ user, passiveIncome, isTapBoostActive, tapProfit, nextLevelText }) => {
  return (
    <motion.div
      className="bg-gradient-to-r from-slate-800/90 to-slate-700/90 backdrop-blur-xl rounded-2xl p-4 border border-amber-500/20 shadow-2xl"
    ...
    >
      <div className="grid grid-cols-3 gap-4">
        ...
        >
          <motion.div 
            className="mb-2 mx-auto w-12 h-12 bg-gradient-to-br from-amber-400 to-orange-500 rounded-xl flex items-center justify-center shadow-lg"
        ...
        {/* Next Level */}
        <motion.div 
          className="text-center border-x border-white/10 px-2 group"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
          <motion.div 
            className="mb-2 mx-auto w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg"
            whileHover={{ 
          ...
          <div className="text-xs text-blue-400 mt-1">Qolgan</div>
        </motion.div>
        ...
        >
          <motion.div 
            className="mb-2 mx-auto w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg"
            animate={{ 
              rotate: [0, 5, -5, 0],
              boxShadow: [
      ...
      {user?.isPremium && (
        ...
        >
          <div className="flex items-center justify-center space-x-4 text-xs">
            ...
            <div className="text-green-400 font-medium">+50% Bonus</div>
            <div className="w-px h-4 bg-amber-500/30"></div>
            <div className="text-purple-400 font-medium">VIP Imtiyozlar</div>
          </div>
        </motion.div>
      )}
